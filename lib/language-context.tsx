...
const translations = {
  en: {
    ...
    'demo.next': 'Next Step',
    'demo.start': 'Start Free Trial',
    'demo.welcome.title': 'Welcome to BookIt by Zewo',
    'demo.welcome.desc': 'Experience the power of WhatsApp-first booking system',
    'demo.plans.title': 'Choose Your Perfect Plan',
    'demo.plans.desc': 'Select the plan that fits your business needs',
    'demo.plans.solo.name': 'Solo',
    'demo.plans.solo.desc': 'Perfect for individual service providers',
    'demo.plans.solo.price': '$19/month',
    'demo.plans.team.name': 'Team',
    'demo.plans.team.desc': 'Great for small teams and multiple locations',
    'demo.plans.team.price': '$39/month',
    'demo.plans.pro.name': 'Pro',
    'demo.plans.pro.desc': 'Full-featured solution for growing businesses',
    'demo.plans.pro.price': '$79/month',
    'demo.plans.month': '/month',
    'demo.plans.popular': 'Most Popular',
    'demo.plans.solo.staff': '1 staff member',
    'demo.plans.solo.location': '1 location',
    'demo.plans.solo.whatsapp': 'WhatsApp manual mode',
    'demo.plans.solo.trial': '30-day free trial',
    'demo.plans.team.staff': 'Up to 5 staff members',
    'demo.plans.team.locations': 'Multiple locations',
    'demo.plans.team.scheduling': 'Advanced scheduling',
    'demo.plans.team.calendar': 'Team calendar views',
    'demo.plans.pro.staff': 'Up to 10 staff members',
    'demo.plans.pro.automation': 'Full automation suite',
    'demo.plans.pro.analytics': 'Advanced analytics & reports',
    'demo.plans.pro.api': 'API access & integrations',
    'demo.signup.title': 'Create Your Account',
    'demo.signup.desc': 'Start your journey with BookIt',
    'demo.signup.name': 'Your Full Name',
    'demo.signup.email': 'Email Address',
    'demo.signup.phone': 'Phone Number',
    'demo.signup.password': 'Password',
    'demo.signup.business': 'Business Name',
    'demo.business.title': 'Set Up Your Business',
    'demo.business.desc': 'Configure your business details and location',
    'demo.business.name': 'Business Name',
    'demo.business.description': 'Description',
    'demo.business.location': 'Business Location',
    'demo.business.phone': 'Business Phone',
    'demo.business.email': 'Business Email',
    'demo.services.title': 'Add Your Services',
    'demo.services.desc': 'Create services your customers can book',
    'demo.services.name': 'Service Name',
    'demo.services.description': 'Service Description',
    'demo.services.duration': 'Duration (minutes)',
    'demo.services.price': 'Price ($)',
    'demo.services.deposit': 'Deposit Required (%)',
    'demo.staff.title': 'Manage Your Staff',
    'demo.staff.desc': 'Add team members and set their availability',
    'demo.website.title': 'Your Personalized Booking Website',
    'demo.website.desc': 'See how your customers will view your custom booking page',
    'demo.website.url': 'Your booking URL: bookit.zewo.com/maria-salon',
    'demo.website.features.custom': 'Fully customizable colors and branding',
    'demo.website.features.mobile': 'Mobile-optimized for WhatsApp sharing',
    'demo.website.features.instant': 'Instant booking with real-time availability',
    'demo.website.features.deposits': 'Secure deposit collection',
    'demo.staff.name': 'Staff Name',
    'demo.staff.email': 'Staff Email',
    'demo.staff.phone': 'Staff Phone',
    'demo.staff.role': 'Role',
    'demo.staff.services': 'Services They Provide',
    'demo.whatsapp.title': 'WhatsApp Booking Experience',
    'demo.whatsapp.desc': 'See how your customers will book appointments',
    'demo.booking.title': 'WhatsApp Booking Experience',
    'demo.booking.desc': 'See how your customers will book appointments',
    'demo.complete.title': 'Ready to Get Started?',
    'demo.complete.desc': 'Join hundreds of service providers eliminating no-shows',
    'demo.whatsapp.customer': 'Hi! I\'d like to book an appointment',
    'demo.whatsapp.bot': 'Great! Click this link to see available times and book instantly:',
    'demo.whatsapp.confirmation': 'Perfect! Your appointment is confirmed for {time}. You\'ll receive a reminder 24h and 2h before.',
    'demo.cta.title': 'Ready to Get Started?',
    'demo.cta.desc': 'Join hundreds of service providers eliminating no-shows',
    'demo.cta.trial': 'Start Your Free Trial',
    'demo.cta.pricing': 'View Pricing',
    'demo.nav.next': 'Next Step',
    'demo.nav.prev': 'Previous',
    'demo.nav.finish': 'Start Free Trial',
    'demo.nav.skip': 'Skip Demo',
    'demo.features.whatsapp': 'Native WhatsApp Integration',
    'demo.features.deposits': 'Smart Deposit Protection',
    'demo.features.bilingual': 'Fully Bilingual (EN/ES)',
    'demo.features.calendar': 'Real-time Availability',
    'demo.features.payments': 'Stripe + ATH Móvil',
    'demo.features.automation': 'Complete Automation',
    'demo.progress': 'Step {current} of {total}',
  ...
  es: {
    ...
    'demo.skip': 'Saltar Demo',
    'demo.step': 'Paso',
    'demo.of': 'de',
    'demo.complete': 'Completo',
    'demo.previous': 'Anterior',
    'demo.next': 'Siguiente Paso',
    'demo.start': 'Comenzar Prueba Gratis',
    'demo.welcome.title': 'Bienvenido a BookIt by Zewo',
    'demo.welcome.desc': 'Experimenta el poder del sistema de reservas por WhatsApp',
    'demo.plans.title': 'Elige Tu Plan Perfecto',
    'demo.plans.desc': 'Selecciona el plan que se adapte a las necesidades de tu negocio',
    'demo.plans.solo.name': 'Solo',
    'demo.plans.solo.desc': 'Perfecto para proveedores de servicios individuales',
    'demo.plans.solo.price': '$19/mes',
    'demo.plans.team.name': 'Equipo',
    'demo.plans.team.desc': 'Excelente para equipos pequeños y múltiples ubicaciones',
    'demo.plans.team.price': '$39/mes',
    'demo.plans.pro.name': 'Pro',
    'demo.plans.pro.desc': 'Solución completa para empresas en crecimiento',
    'demo.plans.pro.price': '$79/mes',
    'demo.plans.month': '/mes',
    'demo.plans.popular': 'Más Popular',
    'demo.plans.solo.staff': '1 miembro del personal',
    'demo.plans.solo.location': '1 ubicación',
    'demo.plans.solo.whatsapp': 'Modo manual de WhatsApp',
    'demo.plans.solo.trial': 'Prueba gratuita de 30 días',
    'demo.plans.team.staff': 'Hasta 5 miembros del personal',
    'demo.plans.team.locations': 'Múltiples ubicaciones',
    'demo.plans.team.scheduling': 'Programación avanzada',
    'demo.plans.team.calendar': 'Vistas de calendario de equipo',
    'demo.plans.pro.staff': 'Hasta 10 miembros del personal',
    'demo.plans.pro.automation': 'Suite de automatización completa',
    'demo.plans.pro.analytics': 'Análisis y reportes avanzados',
    'demo.plans.pro.api': 'Acceso a API e integraciones',
    'demo.signup.title': 'Crea Tu Cuenta',
    'demo.signup.desc': 'Comienza tu viaje con BookIt',
    'demo.signup.name': 'Tu Nombre Completo',
    'demo.signup.email': 'Correo Electrónico',
    'demo.signup.phone': 'Número de Teléfono',
    'demo.signup.password': 'Contraseña',
    'demo.signup.business': 'Nombre del Negocio',
    'demo.business.title': 'Configura Tu Negocio',
    'demo.business.desc': 'Configura los detalles y ubicación de tu negocio',
    'demo.business.name': 'Nombre del Negocio',
    'demo.business.description': 'Descripción',
    'demo.business.location': 'Ubicación del Negocio',
    'demo.business.phone': 'Teléfono del Negocio',
    'demo.business.email': 'Email del Negocio',
    'demo.services.title': 'Agrega Tus Servicios',
    'demo.services.desc': 'Crea servicios que tus clientes puedan reservar',
    'demo.services.name': 'Nombre del Servicio',
    'demo.services.description': 'Descripción del Servicio',
    'demo.services.duration': 'Duración (minutos)',
    'demo.services.price': 'Precio ($)',
    'demo.services.deposit': 'Depósito Requerido (%)',
    'demo.staff.title': 'Gestiona Tu Personal',
    'demo.staff.desc': 'Agrega miembros del equipo y establece su disponibilidad',
    'demo.website.title': 'Tu Sitio Web de Reservas Personalizado',
    'demo.website.desc': 'Ve cómo tus clientes verán tu página de reservas personalizada',
    'demo.website.url': 'Tu URL de reservas: bookit.zewo.com/maria-salon',
    'demo.website.features.custom': 'Colores y marca completamente personalizables',
    'demo.website.features.mobile': 'Optimizado para móvil y compartir por WhatsApp',
    'demo.website.features.instant': 'Reservas instantáneas con disponibilidad en tiempo real',
    'demo.website.features.deposits': 'Cobro seguro de depósitos',
    'demo.staff.name': 'Nombre del Personal',
    'demo.staff.email': 'Email del Personal',
    'demo.staff.phone': 'Teléfono del Personal',
    'demo.staff.role': 'Rol',
    'demo.staff.services': 'Servicios que Proporcionan',
    'demo.whatsapp.title': 'Experiencia de Reservas por WhatsApp',
    'demo.whatsapp.desc': 'Ve cómo tus clientes reservarán citas',
    'demo.booking.title': 'Experiencia de Reservas por WhatsApp',
    'demo.booking.desc': 'Ve cómo tus clientes reservarán citas',
    'demo.complete.title': '¿Listo para Comenzar?',
    'demo.complete.desc': 'Únete a cientos de proveedores de servicios eliminando ausencias',
    'demo.whatsapp.customer': '¡Hola! Me gustaría reservar una cita',
    'demo.whatsapp.bot': '¡Excelente! Haz clic en este enlace para ver horarios disponibles y reservar al instante:',
    'demo.whatsapp.confirmation': '¡Perfecto! Tu cita está confirmada para {time}. Recibirás un recordatorio 24h y 2h antes.',
    'demo.cta.title': '¿Listo para Comenzar?',
    'demo.cta.desc': 'Únete a cientos de proveedores de servicios eliminando ausencias',
    'demo.cta.trial': 'Comienza tu Prueba Gratis',
    'demo.cta.pricing': 'Ver Precios',
    'demo.nav.next': 'Siguiente Paso',
    'demo.nav.prev': 'Anterior',
    'demo.nav.finish': 'Comenzar Prueba Gratis',
    'demo.nav.skip': 'Saltar Demo',
    'demo.features.whatsapp': 'Integración Nativa con WhatsApp',
    'demo.features.deposits': 'Protección Inteligente de Depósitos',
    'demo.features.bilingual': 'Completamente Bilingüe (EN/ES)',
    'demo.features.calendar': 'Disponibilidad en Tiempo Real',
    'demo.features.payments': 'Stripe + ATH Móvil',
    'demo.features.automation': 'Automatización Completa',
    'demo.progress': 'Paso {current} de {total}',
